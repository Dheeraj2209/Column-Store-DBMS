...
int main() {
    ...
    DDLEngine ddlEngine;
    std::string xmlSchemaPath = "schema.xml"; // Adjust path as needed

    std::cout << "Creating column store database from schema: " << xmlSchemaPath << std::endl;
    if (!ddlEngine.createColumnStoreDBfromXMLSchema(xmlSchemaPath)) {
    ...
    std::string customerCsvPath = "C:\Users\LENOVO\OneDrive\Documents\datamodeling\Column-Store-DBMS\example_CSVs\Customer.csv"; // Adjust path as needed
    std::string customerRelationName = "C:\Users\LENOVO\OneDrive\Documents\datamodeling\Column-Store-DBMS\example_CSVs\Customer";
    ...
    std::string orderCsvPath = "Order.csv"; // Adjust path as needed
